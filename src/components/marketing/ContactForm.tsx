        ...
        <form className="grid gap-4 rounded-3xl border border-white/10 bg-white/3 p-6" aria-label="Formulaire de contact">
            ...
            <label className="text-sm text-white/75">
                ...
                <select className="mt-2 w-full rounded-xl border border-white/15 bg-transparent px-3 py-2 text-white">
                    <option className="bg-[var(--bg-primary)]">Commande sur mesure</option>
                    <option className="bg-[var(--bg-primary)]">Fresque murale</option>
                    <option className="bg-[var(--bg-primary)]">Achat d’œuvre</option>
                    <option className="bg-[var(--bg-primary)]">Autre question</option>
                </select>
            </label>
            <label className="text-sm text-white/75">
                Message
