...
export function AboutJourneySection({ content, className }: AboutJourneySectionProps) {
    return (
        <section aria-label="Parcours de l’artiste" className={cn(aboutSectionStyles.section, aboutSectionStyles.pageBackground, className)}>
            ...
            <div aria-hidden="true" className="pointer-events-none absolute left-1/2 top-16 h-24 w-[20rem] -translate-x-1/2 rounded-full bg-[color:var(--accent)]/8 blur-3xl" />
                    ...
                    <div className="relative pl-7 sm:pl-10">
                        ...
                        <div className="grid gap-7 sm:gap-8">
                            {content.fragments.map((fragment) => (
                                ...
                                >
                                    <span className="absolute -left-[2.35rem] top-8 flex h-4 w-4 items-center justify-center rounded-full border border-white/14 bg-[var(--bg-primary)]">
