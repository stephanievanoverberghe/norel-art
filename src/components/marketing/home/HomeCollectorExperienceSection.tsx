...
const accountMoments = [
    {
        title: 'Favoris',
        description: 'Garder les regards qui reviennent en tete avant de choisir.',
        href: '/mon-compte/favoris',
        icon: Heart,
    },
    {
        title: 'Achats',
        description: 'Retrouver commandes, statuts et details apres paiement.',
        href: '/mon-compte/commandes',
        icon: PackageCheck,
    },
    {
        title: 'Certificats',
        description: 'Preparer un espace pour les pieces et editions signees.',
                ...
                <div className="grid gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-end">
                    <div>
                        ...
                        <Heading level={2} className="mt-4 max-w-xl text-white">
                            Une boutique qui garde la memoire de vos pieces.
                        </Heading>
                        <Text variant="muted" className="mt-5 max-w-2xl text-white/66">
                            Le compte n&apos;est pas un simple formulaire de connexion : il devient le carnet personnel des oeuvres aimees, achetees, attendues ou commandees sur mesure.
                        </Text>
