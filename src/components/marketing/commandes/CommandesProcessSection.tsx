...
import type { CommandesProcessSectionContent } from '@/domain/commandes/types';
...
interface CommandesProcessSectionProps {
    id: string;
    content: CommandesProcessSectionContent;
}

export function CommandesProcessSection({ id, content }: CommandesProcessSectionProps) {
    return (
        <CommandesSection id={id}>
            ...
            <div className="mx-auto mt-20 max-w-3xl text-center">
                <div className="rounded-3xl border border-white/10 bg-white/3 px-6 py-6 backdrop-blur-sm sm:px-8 sm:py-7">
                    <p className="text-[11px] uppercase tracking-[0.28em] text-white/34">{content.frameEyebrow}</p>
