...
export function FresquesHero({ content }: FresquesHeroProps) {
    return (
        <section className="relative overflow-hidden bg-(--bg-primary) pt-40 pb-20 sm:pt-44 sm:pb-24 lg:pt-48">
            ...
            <div
                aria-hidden="true"
                className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,rgba(5,10,18,0.82)_0%,rgba(5,10,18,0.45)_45%,rgba(5,10,18,0)_100%)]"
            />
            <div
                aria-hidden="true"
                    ...
                    <div className="relative">
                        ...
                        <div className="relative z-10 mt-10 flex flex-wrap items-center gap-4">
                            ...
                            <div className="inline-flex items-center gap-3 rounded-full border border-white/12 bg-white/4 px-4 py-2 backdrop-blur-md">
                                ...
                                <span className="text-[10px] uppercase tracking-[0.22em] text-white/46">Projet sur devis</span>
                            </div>
                        </div>
                    </div>
