            ...
            <div className="mx-auto max-w-6xl">
                ...
                <header className="mt-10 flex flex-col gap-6 border-b border-white/12 pb-8 sm:flex-row sm:items-end sm:justify-between">
                    <div>
                        ...
                        <h1 className="mt-4 font-(family-name:--font-heading) text-5xl leading-none sm:text-7xl">Mes favoris</h1>
                        <p className="mt-4 max-w-2xl text-base leading-7 text-white/62">
                            Les oeuvres que vous gardez de cote pour y revenir, comparer, ou preparer un achat.
                        </p>
                    </div>
                ...
                {favorites.length > 0 ? (
                    <section className="grid grid-cols-2 gap-5 py-8 md:grid-cols-3 xl:grid-cols-4">
                    ...
                    <section className="py-12">
                        <div className="max-w-xl rounded-md border border-white/10 bg-[#08131f]/78 p-6">
                            ...
                            <p className="mt-3 text-sm leading-6 text-white/56">
                                Parcourez la galerie et utilisez le coeur sur une oeuvre pour la retrouver ici.
                            </p>
                            <Link
                                href="/oeuvres"
