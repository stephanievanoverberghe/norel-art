        ...
        <div className="grid gap-6">
            ...
            <header className="flex flex-col gap-6 border-b border-white/12 pb-7 sm:flex-row sm:items-end sm:justify-between">
                <div>
                    ...
                    <h1 className="mt-4 font-(family-name:--font-heading) text-5xl leading-none text-white sm:text-7xl">Mes commandes</h1>
                    <p className="mt-4 max-w-2xl text-base leading-7 text-white/62">Retrouvez vos achats, leur statut et les details associes.</p>
                </div>
            ...
            {orders.length > 0 ? (
                <section className="grid gap-4">
                    {orders.map((order) => {
                        ...
                        return (
                            <Link key={order.id} href={`/mon-compte/commandes/${order.orderNumber}`} className="grid gap-4 rounded-md border border-white/10 bg-[#08131f]/78 p-5 transition hover:-translate-y-0.5 hover:border-white/22 md:grid-cols-[minmax(0,1fr)_auto]">
                                <div>
                ...
                <section className="max-w-xl rounded-md border border-white/10 bg-[#08131f]/78 p-6">
                    ...
                    <p className="mt-3 text-sm leading-6 text-white/56">Les commandes apparaitront ici apres un paiement valide.</p>
